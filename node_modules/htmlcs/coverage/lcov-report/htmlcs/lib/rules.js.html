...
<html lang="en">
<head>
    <title>Code coverage report for htmlcs/lib/rules.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">htmlcs/lib/</a> rules.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">9476×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">103×</span>
<span class="cline-any cline-yes">2073×</span>
<span class="cline-any cline-yes">14787×</span>
<span class="cline-any cline-yes">14787×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">14787×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">103×</span>
<span class="cline-any cline-yes">2486×</span>
<span class="cline-any cline-yes">2821×</span>
<span class="cline-any cline-yes">2821×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2821×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">1726×</span>
...
&nbsp;
        ...
        [
            ...
            require('./rules/no-space-before-tag-end'),
            require('./rules/protocol-omitted-in-href'),
            require('./rules/new-line-for-blocks'),
            require('./rules/multiple-stylesheets'),
            require('./rules/unnecessary-whitespace-in-text')
...
&nbsp;
                case 'config':
                    ...
                    for (var ruleName in cfg) {
                        <span class="missing-if-branch" title="else path not taken" >E</span>if (cfg.hasOwnProperty(ruleName)) {
...
&nbsp;
        ...
        this.list('parser').forEach(function (rule) {
            var getCfg = function (index, ruleName) {
                ...
                ruleName = ruleName == null ? rule.name : <span class="branch-1 cbranch-no" title="branch not covered" >ruleName;</span>
&nbsp;
...
&nbsp;
        ...
        this.list('document').forEach(function (rule) {
            var getCfg = function (index, ruleName) {
                index = index == null ? <span class="branch-0 cbranch-no" title="branch not covered" >-1 </span>: (index.startIndex || index);
...
<span class="cstat-no" title="statement not covered" >                    console.warn('Error:', e.stack || e);</span>
                }
            }
        });
&nbsp;
