...
<html lang="en">
<head>
    <title>Code coverage report for htmlcs/lib/rules/doctype.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">htmlcs/lib/rules/</a> doctype.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken" >E</span>if (name === '!doctype') {
&nbsp;
