...
function hasChildImageWithAlt(node) {
    return node.children.some((child) => {
        if (child.type === "VElement") {
            if (!isHiddenFromScreenReader_1.default(child) &&
                getElementType_1.default(child) === "img" &&
                getElementAttributeValue_1.default(child, "alt")) {
                return true;
            }
...
function hasContent(node, accessibleChildTypes, accessibleDirectives) {
    return (hasAccessibleChild_1.default(node, accessibleChildTypes) ||
