...
function validateNesting(node, options) {
    return node.children.some((child) => {
        ...
        if (child.type === "VElement") {
            return (!utils_1.isHiddenFromScreenReader(child) &&
                (controlTypes
                    .concat(controlComponents)
                    .includes(utils_1.getElementType(child)) ||
...
function validate(node, rule, options) {
    switch (rule) {
        ...
        case "id":
            return utils_1.getElementAttributeValue(node, "for");
        default:
            return false;
    }
}
...
const rule = {
    meta: {
        docs: {
            url: utils_1.makeDocsURL("label-has-for")
        },
        messages: {
    ...
    create(context) {
        return utils_1.defineTemplateBodyVisitor(context, {
            VElement(node) {
                ...
                if (labelComponents.includes(utils_1.getElementType(node)) &&
